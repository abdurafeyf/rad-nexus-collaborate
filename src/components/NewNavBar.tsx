...
const NewNavBar: React.FC = () => {
  ...
  return (
    ...
    >
            ...
            <div className="flex items-center space-x-3">
              ...
              <Link to="/login/doctor">
                <Button 
                  ...
                  size="sm"
                  className={cn(
                    "bg-teal-500 hover:bg-teal-600 text-white transition-all hover:scale-105 rounded-full",
                    !isScrolled && "bg-white text-teal-600 hover:bg-white/90 hover:text-teal-700"
                  )}
                >
                  Doctor Login
                </Button>
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="md:hidden fixed inset-0 top-[57px] z-40 bg-white">
          <nav className="flex flex-col p-6 space-y-4">
            ...
            <div className="pt-4 flex flex-col space-y-3">
              ...
              <Link to="/register/organization" className="w-full">
                <Button
                  variant="secondary"
                  className="w-full bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-full"
                >
                  Register Institute
                </Button>
              </Link>
